...
func TestReElection2A(t *testing.T) {
	...
	fmt.Println("TestReElection2A: disconnect leader1")
	// if the leader disconnects, a new one should be elected.
	cfg.disconnect(leader1)
	cfg.checkOneLeader()

	fmt.Println("TestReElection2A: rejoin leader1")
	...
	fmt.Println("TestReElection2A: a quorum arises, leader should be elected")
	// if a quorum arises, it should elect a leader.
	cfg.connect((leader2 + 1) % servers)
	cfg.checkOneLeader()

	fmt.Println("TestReElection2A: rejoin leader2")
